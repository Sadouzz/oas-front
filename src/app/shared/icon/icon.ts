  ...
  template: `
    <svg
      ...
      <ng-container [ngSwitch]="name">
        ...
        <!-- Garantie -->
        <ng-container *ngSwitchCase="'shield-heart'">
        ...
        <ng-container *ngSwitchCase="'file-check'">
          <path d="M7 2.5h7l4 4V21a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1z"/>
        ...
        <!-- Climatisation -->
        <ng-container *ngSwitchCase="'snowflake'">
        ...
        <ng-container *ngSwitchCase="'spray'">
        ...
        <ng-container *ngSwitchCase="'user-gear'">
        ...
        <ng-container *ngSwitchCase="'microchip'">
        ...
        <!-- Envoyer un message -->
        <ng-container *ngSwitchCase="'paper-plane'">
          <path d="M3 11.5L20.5 3.5 13 20.8l-2.4-6.2L3 11.5z"/>
          <path d="M10.6 14.6L20.5 3.5"/>
        </ng-container>

        <!-- Itinéraire -->
        <ng-container *ngSwitchCase="'location-arrow'">
