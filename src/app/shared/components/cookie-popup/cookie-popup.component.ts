...
@Component({
  ...
  template: `
    <div *ngIf="showPopup" class="fixed bottom-0 left-0 w-full z-[9999] bg-white border-t border-oas-line shadow-[0_-10px_40px_rgba(12,39,66,0.08)] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 transform transition-transform duration-500 translate-y-0">
